...
<body>
  ...
  <header class="masthead" style="background-image: url('img/home.jpg')">
    ...
    <?php 
        ...
        if($_POST['libroVendido']){
            $libro = $_POST['libroVendido'];
            $comprador = getBookBuyer($libro);
            $libros = getBookById($libro);
        }
    ?>
  <!-- Main Content -->
  <div class="container">
    <div class="row">
            <?php if($_SESSION['usuario']!=NULL): ?>
                ...
                <div class="card-deck col-lg-5" id="books">
                ...
                <?php endforeach ?>
                <div class="alert alert-success text-center col-lg-7 my-auto">Contacta a : <b><?php echo $comprador['email']?></b> para realizar la venta de tu libro.</div>
            <?php endif ?>
    </div>
  </div>
